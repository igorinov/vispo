...
static int fft_combine_interleaved_d(const complex_d *pt_w,
    complex_d *data, int l, int m, int d)
{
	complex_d w, a, b, t;
	int ld = l * d;
	int i, j, k;
...
static int fft_combine_interleaved_s(const complex_s *pt_w,
    complex_s *data, int l, int m, int d)
{
	complex_s w, a, b, t;
	int ld = l * d;
	int i, j, k;
...
int fft_complex_columns_d(const complex_d *ww,
    complex_d *out, const complex_d *in, int size, int step)
{
	int i, j, k;
	int bits = 0;
	int m = 1;
...
int vispo_fft_complex_step_s(const complex_s *ww,
    complex_s *out, const complex_s *in, int size, int step)
{
	int i, j, k;
	int bits = 0;
	int m = 1;
