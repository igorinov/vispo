    ...
    jfloatArray jce, jfloatArray jout, jfloatArray jin, jint size)
{
    ...
    env->ReleaseFloatArrayElements(jcs, ce, JNI_ABORT);  /* read only; not copied back */
    ...
    jdoubleArray jce, jdoubleArray jout, jdoubleArray jin, jint size)
{
    ...
    fft.tables = (complex_d *) ce;
    fft.n = size;
    vispo_fft_complex_s(&fft, (complex_d *) out, (complex_d *) in);
    ...
    jfloatArray jce, jfloatArray jout, jfloatArray jin, jint size)
{
    ...
    fft.tables = (complex_s *) ce;
    fft.n = size;
    vispo_fft_complex_s(&fft, (complex_s *) out, (const float *) in);
    ...
    jdoubleArray jce, jdoubleArray jout, jdoubleArray jin, jint size)
{
    ...
    fft.tables = (complex_d *) ce;
    fft.n = size;
    vispo_fft_complex_s(&fft, (complex_d *) out, (const double *) in);
