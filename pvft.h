...
int dft_real_step_s(const complex_s *w, complex_s *output, const float *input, int n, int in_step);
int dft_real_step_d(const complex_d *w, complex_d *output, const double *input, int n, int in_step);
